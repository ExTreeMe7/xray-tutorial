...
* **Полезные ссылки**: [H89K](https://t.me/h89k_pro), [Xray](https://github.com/XTLS/Xray-core), [V2Ray](https://github.com/v2fly/v2ray-core), [Vless](https://github.com/XTLS/Xray-core/discussions/3518), [V2RayN](https://github.com/2dust/v2rayN), [V2RayNG](https://github.com/2dust/v2rayNG).

* **Навигация**: [Windows 10+](https://github.com/ExTreeMe7/xray-tutorial/blob/main/README.md#v2rayn-windows-10-wiki%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) and [FAQ](https://github.com/ExTreeMe7/xray-tutorial/blob/main/README.md#faq-wiki%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98), [Android](https://github.com/ExTreeMe7/xray-tutorial/blob/main/README.md#v2rayng-android) and [FAQ](https://github.com/ExTreeMe7/xray-tutorial/blob/main/README.md#faq).
...
**V2RayN** и **V2RayNG** — это клиентские программы для работы с платформой Xray/V2Ray, используемой для проксирования и обхода сетевых ограничений. Оба программы являются интерфейсами для ядра Xray/V2Ray и используются для настройки и использования прокси‑соединений.
...
**Nekoray** и **Nekobox** — клиентские программы для работы с прокси-платформами Xray, V2Ray и [Sing-box](https://github.com/SagerNet/sing-box), используемыми для проксирования трафика и обхода сетевых ограничений. Оба программы предоставляют графический интерфейс для настройки прокси-подключений и управления сетевой маршрутизацией.
...
### При запуске ядра пишет ошибку "Failed to run Core"
Может возникать:
* Если core отсутствует, нет файлов - клиент не запустится,
  * v2rayN/
    * bin/
      * xray
      * sing_box
* Если антивирус удаляет прокси-клиент,
* Если путь содержит проблемные названия,

Решение:
* Обновить версию,
* Исключить программу из списка карантина Defender (или вашей организации) или отключить антивирус,
* Изменить директорию хранения папки программы (желательно содержащую только латинские символы, например `C:\v2rayN`),
* Не хранить программу на рабочем столе.
...
* V2RayN не требует установки и не имеет инсталлятора, это portable-программа, его можно разархивировать и использовать на съемном носителе.
...
* Backspace/Delete - Удалить конфигурацию,
...
Запустите программу *от имени администратора*, если основная необходимость это включение режима Tun, если же вы не собираетесь включать режим Tun, то необходимости нет.
...
* **Процесс (режим Tun)** (`Process (Tun mode)` - выбор программы для использования правилом).
...
## FAQ
###  Как использовать ссылки?
Скопируйте полученную ссылку и вставьте в приложении (В профилях, сверху-справа нажмите "**＋**", потом нажмите "**Импорт из буфера обмена**").
